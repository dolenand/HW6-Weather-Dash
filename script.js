...
var owmAPI = "4fbbcb679c8c0904f5635c27fa5cc3ec";
var currentCity = "";
var lastCity = "";
...
var getCurrentConditions = (event) => {
    ...
    .then((response) => {
        ...
        let uvQueryURL = "api.openweathermap.org/data/2.5/weather?lat=" + latitude + "&lon=" + longitude + "&APPID=" + owmAPI;
...
var getFiveDayForecast = (event) => {
    ...
    var queryURL = "api.openweathermap.org/data/2.5/weather?q=" + city + "&units=imperial" + "&APPID=" + owmAPI;
    // Fetch from API
    fetch(queryURL)
        .then (handleErrors)
        .then((response) => {
